...
/**
 * Concrete implementation of GamePiece for Blue player.
 * 
 * Demonstrates:
 * - Inheritance: Extends GamePiece
 * - Polymorphism: Implements abstract render() method with Blue-specific rendering
 */
public class BluePiece extends GamePiece {
    
    public BluePiece(int pieceNumber) {
        super(pieceNumber, PlayerColor.BLUE);
    }
    
    /**
     * Renders the blue piece with a blue circle and border.
     * 
    ...
    public void render(GraphicsContext gc, double x, double y, double size) {
        ...
        // Border
        gc.setStroke(Color.rgb(0, 0, 139)); // Dark blue border
        gc.setLineWidth(2);
